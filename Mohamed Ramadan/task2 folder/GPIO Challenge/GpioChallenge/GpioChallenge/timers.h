...
typedef enum En_timer0Mode_t{
	...
	T0_NORMAL_MODE=0,T0_COMP_MODE=0x08,T0_F_PWM_MODE=0x48
}En_timer0Mode_t;
...
typedef enum En_timer1Mode_t{
	...
	T1_NORMAL_MODE=0x0000,T1_COMP_MODE_OCR1A_TOP=0x0008, T1_COMP_MODE_ICR1_TOP = 0x0018, T1_FAST_PWM_MODE_OCR1A_TOP=0x0318, T1_FAST_PWM_MODE_ICR1_TOP=0x0218
...
typedef enum En_timer1OC_t{
	...
	T1_OC1B_CLEAR=0x2000,T1_OC1A_SET=0xC000,T1_OC1B_SET=0x3000

}En_timer1OC_t;

typedef enum En_timer1perscaler_t{
	
	T1_NO_CLOCK=0x11111000,T1_PRESCALER_NO=0x0001,T1_PRESCALER_8=0x0002,T1_PRESCALER_64=0x0003,
 ...
 * @param interruptMask
 */
void timer1Init(En_timer1Mode_t en_mode,En_timer1OC_t en_OC,En_timer1perscaler_t en_prescal, uint16_t u16_initialValue,
				 uint16_t u16_outputCompareA, uint16_t u16_outputCompareB,uint16_t u16_inputCapture,
