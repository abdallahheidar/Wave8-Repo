...
static volatile uint8_t gu8_SPIRECEIVECOMP = 0;
...
EnmBCMError_t BCM_Receive(strBcmSendConfig_t* ConfigPtr)
{
	...
	ConfigPtr->BCM_ArrayStartAddress[gu8_RxCounter] = apf_ReceiverFunction();
	   ...
	   //TCNT0 =ConfigPtr->BCM_ArrayStartAddress[7];
		//TCNT0 = ConfigPtr->BCM_ArrayStartAddress[gu8_RxCounter];
		//PORTC_DIR = apf_ReceiverFunction();
