...
#define GPIODATA(BASE_ADDRESS)				*((volatile uint32_t*)(BASE_ADDRESS + GPIODATA_OFFSET))
...
#define ADC_0  0x40038000 
#define ADC_1  0x40039000
...
#define ADCSSMUX_OFFSET    0x000

#define ADCSSCTL_OFFSET    0x004
#define ADCSSFIFO_OFFSET   0x008
#define ADCSSFSTAT_OFFSET  0x00C
#define ADCSSOP_OFFSET     0x010
#define ADCSSDC_OFFSET     0x014

//#define GPIODIR(BASE_ADDRESS)					*((volatile uint32_t*)(BASE_ADDRESS + GPIODIR_OFFSET))

#define ADCACTSS(BASE_ADDRESS)     			*((volatile uint32_t*)(BASE_ADDRESS + ADCACTSS_OFFSET))
#define ADCRIS(BASE_ADDRESS)   			    *((volatile uint32_t*)(BASE_ADDRESS + ADCRIS_OFFSET))
#define ADCIM(BASE_ADDRESS)   		      *((volatile uint32_t*)(BASE_ADDRESS + ADCIM_OFFSET))
#define ADCISC(BASE_ADDRESS)       			*((volatile uint32_t*)(BASE_ADDRESS + ADCISC_OFFSET))
#define ADCOSTAT(BASE_ADDRESS)     			*((volatile uint32_t*)(BASE_ADDRESS + ADCOSTAT_OFFSET))
#define ADCEMUX(BASE_ADDRESS)      			*((volatile uint32_t*)(BASE_ADDRESS + ADCEMUX_OFFSET))
	

#define ADCUSTAT(BASE_ADDRESS)     			*((volatile uint32_t*)(BASE_ADDRESS + ADCUSTAT_OFFSET))
#define ADCTSSEL(BASE_ADDRESS)     			*((volatile uint32_t*)(BASE_ADDRESS + ADCTSSEL_OFFSET))
#define ADCSSPRI(BASE_ADDRESS)     			*((volatile uint32_t*)(BASE_ADDRESS + ADCSSPRI_OFFSET))
#define ADCSPC(BASE_ADDRESS)       			*((volatile uint32_t*)(BASE_ADDRESS + ADCSPC_OFFSET))
#define ADCPSSI(BASE_ADDRESS)      			*((volatile uint32_t*)(BASE_ADDRESS + ADCPSSI_OFFSET))
#define ADCSAC(BASE_ADDRESS)       			*((volatile uint32_t*)(BASE_ADDRESS + ADCSAC_OFFSET))
	
#define ADCDCISC(BASE_ADDRESS)     			*((volatile uint32_t*)(BASE_ADDRESS + ADCDCISC_OFFSET))
#define ADCCTL(BASE_ADDRESS)       			*((volatile uint32_t*)(BASE_ADDRESS + ADCCTL_OFFSET))





#define ADCSSMUX(BASE_ADDRESS ,SEQ_BASE_ADDRESS )       			*((volatile uint32_t*)(BASE_ADDRESS + SEQ_BASE_ADDRESS + ADCSSMUX_OFFSET))

#define ADCSSCTL(BASE_ADDRESS ,SEQ_BASE_ADDRESS )     				*((volatile uint32_t*)(BASE_ADDRESS + SEQ_BASE_ADDRESS + ADCSSCTL_OFFSET))
#define ADCSSFIFO(BASE_ADDRESS ,SEQ_BASE_ADDRESS )    				*((volatile uint32_t*)(BASE_ADDRESS + SEQ_BASE_ADDRESS + ADCSSFIFO_OFFSET))
#define ADCSSFSTAT(BASE_ADDRESS ,SEQ_BASE_ADDRESS )  					*((volatile uint32_t*)(BASE_ADDRESS + SEQ_BASE_ADDRESS + ADCSSFSTAT_OFFSET))
#define ADCSSOP(BASE_ADDRESS ,SEQ_BASE_ADDRESS )      				*((volatile uint32_t*)(BASE_ADDRESS + SEQ_BASE_ADDRESS + ADCSSOP_OFFSET))
#define ADCSSDC(BASE_ADDRESS ,SEQ_BASE_ADDRESS )      				*((volatile uint32_t*)(BASE_ADDRESS + SEQ_BASE_ADDRESS + ADCSSDC_OFFSET))
