 ...
 */
extern ERROR_STATUS gpioPortDirection(uint8_t u8_port, uint8_t u8_direction);
 ...
 * @return Function Error Status
 */
extern ERROR_STATUS gpioPortWrite(uint8_t u8_port, uint8_t u8_value);
 ...
 * @return Function Error Status
 */
extern ERROR_STATUS gpioPortToggle(uint8_t u8_port);
 ...
 * @return Function Error Status
 */
extern ERROR_STATUS gpioPortRead(uint8_t u8_port , uint8_t* u8_PortValue);
 ...
 * 				- 0xFF -> Output
 */
extern ERROR_STATUS gpioPinDirection(uint8_t u8_port, uint8_t u8_pins, uint8_t u8_direction);
 ...
 * @param value
 */
extern ERROR_STATUS gpioPinWrite(uint8_t u8_port, uint8_t u8_pins, uint8_t u8_value);
 ...
 */
extern ERROR_STATUS gpioPinToggle(uint8_t u8_port, uint8_t u8_pins);
