		...
		if(astr_BTN_Cfg[en_butotn_id].s8_BTN_Status <= UNINT)
		{
			...
			* staut_flag = Released;
			switch(u8_BTN_GetStatusState){
				...
				{
					astr_BTN_Cfg[en_butotn_id].s8_BTN_Status = 1;
				...
				{
					astr_BTN_Cfg[en_butotn_id].u8_BTN_DelayCount=0;
				...
				if(astr_BTN_Cfg[en_butotn_id].s8_BTN_Status>=25)
				{
					*staut_flag = Pressed;
				}
				astr_BTN_Cfg[en_butotn_id].s8_BTN_Status = 0;
				astr_BTN_Cfg[en_butotn_id].u8_BTN_DelayCount=0;
				u8_BTN_ErrorStatus = 0xff;
