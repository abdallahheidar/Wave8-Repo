...
static void (*Ptr_Timer0_Call_Back_Func) (void)=NULL;
static void (*Ptr_Timer1_Call_Back_Func) (void)=NULL;
static void (*Ptr_Timer2_Call_Back_Func) (void)=NULL;
/* GLOBAL EXTERN VARIABLES */
volatile uint8_t gu8_Over_FlowCounts=ZERO;


/*local functions */
static void Timer0_CallBack_Set(void (* ptr_Timer_CallBack_Func) (void));
static void Timer1_CallBack_Set(void (* ptr_Timer_CallBack_Func) (void));
static void Timer2_CallBack_Set(void (* ptr_Timer_CallBack_Func) (void));
		  ...
		  {  
			  ...
			  {   
					if(gpstr_Timer_Cfg->Timer_Mode==TIMER_MODE)
					{
						...
						Timer0_CallBack_Set(gpstr_Timer_Cfg-> ptr_Timer_CallBack_Func);
					}
					else
					{
			  ...
			  {  
					...
					{ 
						...
						TIMSK|=gpstr_Timer_Cfg->Timer_INT_Mode;
						Timer1_CallBack_Set(gpstr_Timer_Cfg-> ptr_Timer_CallBack_Func);
					}
					else
					{
			  ...
			  case TIMER_2 :
			  {
					if(gpstr_Timer_Cfg->Timer_Mode==TIMER_MODE)
					{
						...
						TIMSK|= gpstr_Timer_Cfg->Timer_INT_Mode;
						Timer2_CallBack_Set(gpstr_Timer_Cfg-> ptr_Timer_CallBack_Func);
						ASSR|=0;
					}
					else
					{
...
static void Timer0_CallBack_Set(void (* ptr_Timer_CallBack_Func) (void))
{
	...
	Ptr_Timer0_Call_Back_Func= ptr_Timer_CallBack_Func;
}
static void Timer1_CallBack_Set(void (* ptr_Timer_CallBack_Func) (void))
{
	
	Ptr_Timer1_Call_Back_Func= ptr_Timer_CallBack_Func;
}
static void Timer2_CallBack_Set(void (* ptr_Timer_CallBack_Func) (void))
{
	
	Ptr_Timer2_Call_Back_Func= ptr_Timer_CallBack_Func;
}
