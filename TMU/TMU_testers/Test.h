 ...
 *
 */
void TMU_Start_Timer_Test(void);
 ...
 *
 */
void TMU_Stop_Timer_Test(void);

/**
 * Description: Tests the TMU_Dispatch function
 * Test Cases :
 *				1- dispatching before initializing the TMU
