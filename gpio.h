...
{
	BIT0EN = 0x01,	// defines BIT0 in a register
	BIT1EN = 0x02,	// defines BIT1 in a register
	BIT2EN = 0x04,	// defines BIT2 in a register
	BIT3EN = 0x08,	// defines BIT3 in a register
	BIT4EN = 0x10,	// defines BIT4 in a register
	BIT5EN = 0x20,	// defines BIT5 in a register
	BIT6EN = 0x40,	// defines BIT6 in a register
	BIT7EN = 0x80,	// defines BIT7 in a register
}EN_bits_t;
/*
#define INPUT	(0)
#define OUTPUT	(0xFF)
