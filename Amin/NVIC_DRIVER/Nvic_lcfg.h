...
/*NVIC INTURREPT NUMBER */
#define NVIC_INT0_GPIOA                                 0
#define NVIC_INT1_GPIOB                                 1
#define NVIC_INT2_GPIOC                                 2
#define NVIC_INT3_GPIOD                                 3
#define NVIC_INT4_GPIOE                                 4
