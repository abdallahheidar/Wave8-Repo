...
*****************************************************************************/
extern ERROR_STATUS Task_Delet(uint8_t Task_Id, ERROR_STATUS(* Ptr_Func)(void));
...
*****************************************************************************/
extern ERROR_STATUS Task_Creat (uint16_t Time_Delay,uint8_t Task_Priorty, uint8_t Repeat, ERROR_STATUS(* Ptr_Func)(void));
