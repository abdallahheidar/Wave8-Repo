 ...
 * Input		: 														   *
 *				Local_Ptr --> pointer to function in the application layer *
 ...
 * 				  - E_OK : successful									   *
 *				  - E_NOK : not successful								   *
 * Description	: sets the call back operation to a function in the		   *
 * 				  application layer				       					   *
 ***************************************************************************/
extern ERROR_STATUS Icu_SetCallBack(void(*Local_Ptr)(void));
